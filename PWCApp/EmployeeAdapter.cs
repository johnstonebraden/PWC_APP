...
namespace PWCApp
{
    ...
    public class EmployeeAdapter : BaseAdapter<Employee>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Resource.Id.lblSubTitle).Text = item.empType.ToString();
            view.FindViewById<TextView>(Resource.Id.lblInfo).Text = item.empMobile.ToString();
